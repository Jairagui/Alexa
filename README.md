...
Skill Coach
ARCHIVOS:
ambda_function.py:Para nosotros, el archivo lambda_function.py representa el núcleo de la skill en 
...
rutina_servicio.py:En este archivo ubicamos la clase RoutineFacade que es básicamente la encargada 
...
modos_rutina.py:En este archivo concentramos la lógica para los modos de rutina ya sea manual o 
...
rutina_creador.py:En este archivo nos encargamos de armar la rutina paso a paso ya que su función 
...
selector_sets.py:En este módulo concentramos la responsabilidad de elegir el set de ejercicios 
...
imc.py:En este archivo encapsulamos toda la lógica relacionada con el IMC 
...
routines.json:En este archivo guardamos toda la base de datos de los ejercicios en formato 
...
requirements.txt:En este archivo listamos todas las dependencias externas del proyecto como el 
